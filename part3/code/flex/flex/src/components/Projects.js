...
const Projects = () => {
  return (
    <div style={{ fontFamily: 'Arial, sans-serif', backgroundColor: '#ebf6fa', margin: 0, padding: 0 }}>
      ...
      <div style={{ padding: '20px', display: 'flex', justifyContent: 'space-evenly', flexWrap: 'wrap', gap: '20px' }}>

        <div style={{ backgroundColor: '#fff', borderRadius: '10px', padding: '15px', textAlign: 'center', width: '250px', boxShadow: '0 4px 6px rgba(0, 0, 0, 0.2)' }}>
